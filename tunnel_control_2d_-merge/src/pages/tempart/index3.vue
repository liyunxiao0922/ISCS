<template>
  <div class="face-recognition-container" ref="temWrapper">
    ...
    <div ref="wrapper" class="wrapper" v-for="(item, ind) in currentType" :key="ind">
      <div class="content" ref="content">
          <p class="title">
            ...
            <el-dropdown @command="handleCommand" trigger="click">
              <span class="icon-set el-icon-s-tools"></span>
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item v-for="(item, index) in temData" :key="index" :class="{active: temData.includes(currentType[index])}" :command="item">{{item}}</el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </p>
          <dataContent :value="item" :collapse="collapse" :allData="allData"></dataContent>
      </div>
